...
static auto collect_type(
  ...
  if (*kind != Llvm::Representation::Carriers::Kind::Value &&
      *kind != Llvm::Representation::Carriers::Kind::Enumeration &&
      *kind != Llvm::Representation::Carriers::Kind::Context) {
  ...
  switch (*kind) {
  case Llvm::Representation::Carriers::Kind::Value:
  case Llvm::Representation::Carriers::Kind::ObjectStorage:
  case Llvm::Representation::Carriers::Kind::Object:
    ordered.insert(&type);
    return True;

  case Llvm::Representation::Carriers::Kind::Structure: {
  ...
  case Llvm::Representation::Carriers::Kind::Result: {
  ...
  case Llvm::Representation::Carriers::Kind::Enumeration:
  case Llvm::Representation::Carriers::Kind::Fixed:
  case Llvm::Representation::Carriers::Kind::Option:
  case Llvm::Representation::Carriers::Kind::Range:
  case Llvm::Representation::Carriers::Kind::View:
  case Llvm::Representation::Carriers::Kind::Access: {
  ...
  case Llvm::Representation::Carriers::Kind::Context:
    return fail_header(
...
auto Llvm::Abi::Header::create(
    Memory::Allocator::Arena& arena,
    const Llvm::Representation::Carriers& carriers,
    const Llvm::Representation::Functions& functions,
    const Llvm::Representation::Globals& globals,
    const Llvm::Abi::Unit& unit,
    Core::View::Vector<Llvm::Abi::Export> exports)
    -> Core::Option<Llvm::Abi::Header> {
  ...
  output << "\n#ifdef __cplusplus\n}\n#endif\n"_view;
  return Llvm::Abi::Header(buffer.get_view());
}

auto Llvm::Abi::Header::identify(
    Memory::Allocator::Arena& arena,
