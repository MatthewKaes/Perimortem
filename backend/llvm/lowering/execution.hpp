...
#include "backend/llvm/emission/computation.hpp"
...
// and this backend decides how that meaning becomes target operations.
class Execution {
 public:
  constexpr explicit Execution(Representation::Body& body)
      : computation(body),
        invocation(body),
        control_flow(body),
        states(body),
