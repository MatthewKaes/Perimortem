...
static auto select_kind(const Model::Type& type)
    -> Core::Option<Llvm::Representation::Carriers::Kind> {
  using Kind = Llvm::Representation::Carriers::Kind;
...
static auto reserve_layout(
    Llvm::Representation::Program& program,
    const Ttx::Concept::Layout& layout) -> Bool;
