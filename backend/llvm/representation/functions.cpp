...
static auto select_body(Llvm::Representation::Emission& emission)
    -> Core::Option<Llvm::Representation::Body&> {
  return emission.get_kind() == Llvm::Representation::Emission::Kind::Body
             ? Core::Option<Llvm::Representation::Body&>(
                   static_cast<Llvm::Representation::Body&>(emission))
             : Core::Option<Llvm::Representation::Body&>();
}

static auto select_carriers(Llvm::Representation::Emission& program)
...
static auto select_function_attributes(
  ...
  if (symbol && !Llvm::Abi::Symbol::validate(*symbol)) {
    return fail_callable(
        program, definition,
...
auto Llvm::Representation::Functions::reserve(
    Llvm::Representation::Emission& program,
    const Ttx::Model::Callable& callable,
...
auto Llvm::Representation::Functions::reserve_function(
    Llvm::Representation::Emission& program,
    const Ttx::Model::Callable& callable,
...
auto Llvm::Representation::Functions::reserve_foreign(
    Llvm::Representation::Emission& program,
    const Ttx::Model::Callable& callable,
    Core::View::Bytes abi,
  ...
  if (!Llvm::Abi::Symbol::validate(symbol)) {
    fail_callable(
        program, {},
...
auto Llvm::Representation::Functions::reserve_construction(
    Llvm::Representation::Emission& program,
  ...
  Llvm::Abi::Symbol generated(
      target->get_arena(), owner, Llvm::Abi::Symbol::Kind::Construction,
      target->get_unit());
...
auto Llvm::Representation::Functions::complete_construction(
    Llvm::Representation::Emission& program,
  ...
  if (record.provider && target->get_unit().is_package_member()) {
    target->add_publication(Llvm::Abi::Publication(owner, record.symbol));
  }
  return True;
}
...
auto Llvm::Representation::Functions::lower_construction(
    Llvm::Representation::Emission& program,
    const Ttx::Model::Type& owner,
  ...
  Llvm::Representation::Body native_body(
...
auto Llvm::Representation::Functions::call_construction(
...
auto Llvm::Representation::Functions::complete(
    Llvm::Representation::Emission& program,
  ...
  if (record.kind == Kind::Function && symbol) {
    ...
    Llvm::Abi::Symbol generated(
        ...
        declares_self(callable) ? Llvm::Abi::Symbol::Kind::FunctionSelf
                                : Llvm::Abi::Symbol::Kind::FunctionStatic,
        target->get_unit());
  ...
  if (c_publication || package_publication) {
    target->add_export(Llvm::Abi::Export(callable, selected_symbol));
  }
  if (target->get_unit().is_package_member() &&
      (c_publication || package_publication)) {
    target->add_publication(Llvm::Abi::Publication(callable, selected_symbol));
  }

  return True;
}

auto Llvm::Representation::Functions::begin_body(
    Llvm::Representation::Emission& program,
...
auto Llvm::Representation::Functions::bind_parameters(
    Llvm::Representation::Emission& body,
    const Ttx::Model::Callable& callable) const -> Bool {
  auto native_body = select_body(body);
  auto found = records.find(&callable);
...
auto Llvm::Representation::Functions::end_body(
    Llvm::Representation::Emission& body,
    const Ttx::Model::Callable& callable) const -> Bool {
  auto native_body = select_body(body);
...
auto Llvm::Representation::Functions::find_function(
...
auto Llvm::Representation::Functions::find_symbol(
...
auto Llvm::Representation::Functions::find_sret_type(
...
auto Llvm::Representation::Functions::get_indirect_parameters(
...
auto Llvm::Representation::Functions::get_foreign_callables() const
