...
constexpr auto optimize_size = False;
static Count default_construct_count = 0;
static Count default_destruct_count = 0;

Test::Harness DynamicMap256 = {.name = "Dynamic::Map::256", .setup = []() {
...
PERIMORTEM_UNIT_TEST(DynamicMap256, empty) {
...
PERIMORTEM_UNIT_TEST(DynamicMap256, simple_construction) {
...
PERIMORTEM_UNIT_TEST(DynamicMap256, insert_on_index) {
  Dynamic::Map<Int, Int, optimize_size> empty_map;
...
PERIMORTEM_UNIT_TEST(DynamicMap256, duplicate_keys) {
...
PERIMORTEM_UNIT_TEST(DynamicMap256, empty_keys) {
...
PERIMORTEM_UNIT_TEST(DynamicMap256, insert_stress_test) {
...
PERIMORTEM_UNIT_TEST(DynamicMap256, capacity_stress_test) {
  Dynamic::Map<Int, Int, optimize_size> large_map;
...
PERIMORTEM_UNIT_TEST(DynamicMap256, key_construction_count) {
...
PERIMORTEM_UNIT_TEST(DynamicMap256, value_construction_count) {
  Count construct_count = 0;
  Count destruct_count = 0;
...
PERIMORTEM_UNIT_TEST(DynamicMap256, emplace_construction_count) {
  Count construct_count = 0;
  Count destruct_count = 0;
...
PERIMORTEM_UNIT_TEST(DynamicMap256, dynamic_keys) {
...
PERIMORTEM_UNIT_TEST(DynamicMap256, dynamic_value) {
...
PERIMORTEM_UNIT_TEST(DynamicMap256, size) {
  Dynamic::Map<Int, Int, optimize_size> empty_map;
  EXPECT_EQ(sizeof(empty_map), 32);
...
PERIMORTEM_UNIT_TEST(DynamicMap256, reuse) {
...
PERIMORTEM_UNIT_TEST(DynamicMap256, leak_test) {
