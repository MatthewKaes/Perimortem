...
TEST_F(DiskWriterTests, simple_disk_max_compressed) {
  Writer writer;
  writer.create(Type::Compressed, CompressionLevels::Smallest);
...
TEST_F(DiskWriterTests, memory_disk) {
  Writer writer;
  writer.create(Type::Memory, CompressionLevels::Smallest);
...
TEST_F(DiskWriterTests, stream_disk) {
  Writer writer;
  writer.create(Type::Streamed, CompressionLevels::Smallest);
...
TEST_F(DiskWriterTests, stream_compressed_disk) {
  Writer writer;
  writer.create(Type::StreamedCompressed, CompressionLevels::Smallest);
