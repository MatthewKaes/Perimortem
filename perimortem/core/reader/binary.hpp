...
// fields, mirroring the layout produced by Writer::Binary.
//
...
// alignment and always read from the current position.
//
...
class Binary {
 public:
  constexpr Binary(Core::View::Bytes source) : data(source) {}
  ...
  auto read_bytes(Count count) -> Core::View::Bytes;
