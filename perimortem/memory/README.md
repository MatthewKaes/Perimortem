...
`Memory::Dynamic::Record<T>` supplies typed C++ lifetime management for tooling
...
Bibliotheca, Perimortem's page allocator, supplies Record storage local to one
worker. Core interprets the adjacent Object descriptor when the final
