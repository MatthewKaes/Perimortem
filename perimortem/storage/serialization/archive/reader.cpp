...
#include "perimortem/storage/serialization/archive/reader.hpp"

#include <zstd.h>

using namespace Perimortem::Memory;
using namespace Perimortem::Storage::Serialization::Archive;
...
auto Reader::Load(View::Bytes archive) {
  blocks[0].reset();
  blocks[1].reset();
