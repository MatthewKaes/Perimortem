...
#include "perimortem/storage/serialization/archive/info.hpp"

namespace Perimortem::Storage::Serialization::Archive {

class Reader {
 public:
  auto Load(Memory::View::Bytes archive);

  inline auto get_format() const -> Type { return format; }
  inline auto get_files() const -> const Memory::View::Vector<Object> {
