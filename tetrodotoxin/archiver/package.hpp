...
// Tetrodotoxin::Model::Package::Resolved, and the replacement reader
// reconstructs Model::Package::Precompiled. Do not adapt Source or the current
// package model into this root-Type representation merely to preserve the old
// format.
//
