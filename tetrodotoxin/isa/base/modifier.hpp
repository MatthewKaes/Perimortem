...
// The lexical Code is returned directly so the parser does not manufacture a
...
class Modifier {
 public:
  static auto evaluate(
      ...
      Perimortem::Core::View::Vector<Ttx::Lexical::Code::Type> allowed,
      Perimortem::Core::View::Bytes error_message) -> Ttx::Lexical::Code::Type;
};
