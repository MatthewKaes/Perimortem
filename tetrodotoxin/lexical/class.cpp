...
auto Class::get_name() const -> Perimortem::Core::View::Bytes {
  ...
  case Type::Library:
    return "ttx library package"_view;
  case Type::Shader:
    return "ttx shader package"_view;
  case Type::Entity:
    return "ttx entity package"_view;
  case Type::Object:
  ...
  case Type::Foreign:
    return "foreign ABI definition"_view;
  case Type::Alias:
  ...
  case Type::IndexStart:
    return "index or layout operator `[`"_view;
  case Type::IndexEnd:
    return "closing index or layout operator `]`"_view;
  case Type::Define:
