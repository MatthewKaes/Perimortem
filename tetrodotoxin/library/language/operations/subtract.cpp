...
static auto select_result_type(
  ...
  // Subtract never retags a Tetrodotoxin::Library::Language::Constant to make
  // the pair legal. Both retained inputs expose this same Type before
  // arithmetic begins.
...
auto Language::Operations::Subtract::evaluate_constants(
  ...
  // only the Tetrodotoxin::Library::Language::Constant payload contract needed
