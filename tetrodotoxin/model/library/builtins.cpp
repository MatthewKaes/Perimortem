...
#include "tetrodotoxin/model/library/builtins.hpp"
...
static constexpr Perimortem::Core::Static::Vector<
    ...
    builtin_source = {{
      ...
      // Count is Tetrodotoxin's ordinary size alias. Parsing returns the
      // resolved Unsigned_64 Type identity rather than manufacturing a second
      // alias Type.
      {"Count"_view, unsigned_64},
    }};

using BuiltinTable = Perimortem::Utility::
    Table<Perimortem::Utility::Option<const Ttx::Model::Type&>, builtin_source>;

auto Library::Builtins::find(Perimortem::Core::View::Bytes name)
    -> Perimortem::Utility::Option<const Ttx::Model::Type&> {
