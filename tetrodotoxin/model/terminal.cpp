...
Tetrodotoxin::Model::Terminal::Terminal(
    Perimortem::Memory::Allocator::Arena& arena,
    View::Bytes path,
    View::Bytes content)
    : path(arena.proxy(path)), content(arena.proxy(content)) {}

auto Tetrodotoxin::Model::Terminal::get_path() const -> View::Bytes {
  return path;
}

auto Tetrodotoxin::Model::Terminal::get_content() const -> View::Bytes {
  return content;
}

auto Tetrodotoxin::Model::Terminal::is_valid_path(View::Bytes path) -> Bool {
