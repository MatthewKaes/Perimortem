...
class Plan {
 ...
 private:
  ...
  auto add_to_kind(Record& record, RecordKind kind) -> void;
  auto lower_records(Perimortem::Core::View::Vector<Record*> records) -> Bool;
  auto lower_record(Record& record) -> Bool;
  ...
  Tetrodotoxin::Compiler::Context compiler_context;
  ...
  Perimortem::Memory::Dynamic::Vector<Record*> library_records;
  Perimortem::Memory::Dynamic::Vector<Record*> render_records;
  Perimortem::Memory::Dynamic::Vector<Record*> shader_records;
