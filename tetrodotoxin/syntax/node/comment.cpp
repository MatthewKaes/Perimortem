...
// // Supported comment blocks can't be more than 128 lines, and will break if
// they
// // are ~16KB of text. This limit is arbitrary but larger comments start
// creating
// // bloat in both the parser and LSP. The limit on a single block should be
// more
...
//   auto buffer = Data::cast<char*>(ctx.get_allocator().allocate(total_bytes));
