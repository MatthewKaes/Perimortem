...
// Products is the source independent Vulkan pipeline description derived from
// one completed Shader Program and its SPIR V symbol. Its compact records are
// physical target facts and retain no semantic identities after generation.
class Products {
 public:
  enum class Stage : U8 {
    Vertex,
