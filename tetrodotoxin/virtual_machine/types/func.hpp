...
class Func : public Abstract {
 public:
  ...
  constexpr auto get_name() const -> const Perimortem::Memory::View::Bytes override { return name; };
  ...
  auto resolve_scope(const Perimortem::Memory::View::Bytes name) const -> const Abstract* override {
 ...
 private:
  ...
  std::unordered_map<const Perimortem::Memory::View::Bytes, const Abstract*> name_index;
};
