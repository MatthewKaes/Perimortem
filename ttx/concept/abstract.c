...
const struct ttx_abstract* ttx_abstract_resolve(const struct ttx_abstract* abstract) {
  return abstract->operations->resolve(abstract);
}

const struct ttx_abstract* ttx_abstract_type(const struct ttx_abstract* abstract) {
