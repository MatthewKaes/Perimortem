...
auto View::find(Perimortem::Core::View::Vector<Argument> arguments) const
  ...
  // View has one formula contract, so its environment-owned cache is keyed by
  // the real element identity. Cache entries are never null.
