...
//     p /= ::testing::Unitstatic
//     HarnessGetInstance()->current_test_info()->name();
//     p.replace_extension(Archive::virutal_extension);
//     reader = Archive::Reader::mount_archive(p);
//   }

//   virtual void TearDown() {
//     if (::testing::static HarnessHasFailure()) {
