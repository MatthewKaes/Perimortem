...
PERIMORTEM_UNIT_TEST(TetrodotoxinAbi, function_tables_define_abi_paths) {
  ...
  identities.insert(Abi::Type::create(arena, "Validation.Scalar"_view, scalar));
  View::Bytes type_symbol = Abi::Symbol::exported(
...
PERIMORTEM_UNIT_TEST(TetrodotoxinAbi, export_ignores_source_placement) {
  ...
  View::Bytes source_a = Abi::Symbol::type(
      arena, "Validation.Unit"_view, "source_a"_view, "Owner"_view, *function);
  View::Bytes source_b = Abi::Symbol::type(
      arena, "Validation.Unit"_view, "source_b"_view, "Owner"_view, *function);
  View::Bytes other_unit = Abi::Symbol::type(
      arena, "Validation.Other"_view, "source_a"_view, "Owner"_view, *function);
