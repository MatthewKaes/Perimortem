...
//   EXPECT_EQ(Assembler::SpirV::literal_string_word_count("abc"_view),
//   Count(1));
//   EXPECT_EQ(Assembler::SpirV::literal_string_word_count("abcd"_view),
//   Count(2));
...
//   assembler.mov(Unsigned_64(0xFFFFFFFF80000000),
//   Assembler::x86_64::Reg::RAX); assembler.mov(Unsigned_64(0x100000000),
...
//   Assembler::x86_64 assembler(machine_code);
//   assembler.mov(
//       Assembler::x86_64::Reg::RAX, Assembler::x86_64::Reg::RSP,
//       Signed_32(8));
//   assembler.mov(
