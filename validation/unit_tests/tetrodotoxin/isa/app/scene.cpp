...
//   ASSERT(icon != nullptr);
//   ASSERT(fade != nullptr);
//   EXPECT(icon->get_modifier() == Ttx::Lexical::Code::Type::State);
//   EXPECT(fade->get_modifier() == Ttx::Lexical::Code::Type::Const);
...
//       "Scene root addressable must be on_start, on_update, or
//       on_exit."_view);
// }
...
//       resolver.load_source(app_source_context,
//       "apps/ttx/demo/main.ttx"_view);
//   ASSERT(app != nullptr);
//   EXPECT_NOT(app_source_context.has_errors());
...
//   EXPECT(addressable_function(scene->get_type(), "on_update"_view) !=
//   nullptr);
// }
...
//   EXPECT_NOT(resolver.load_source(
//       app_source_context, "unit/empty_app.ttx"_view, "dialect :
//       App;\n"_view));
...
//   ASSERT(record != nullptr);
//   EXPECT_NOT(scene_source_context.has_errors());
//   EXPECT(addressable_function(record->get_type(), "on_start"_view) !=
//   nullptr); EXPECT(addressable_function(record->get_type(), "on_exit"_view)
//   != nullptr);
// }
