...
//   EXPECT(implementation.find<Compiler::Execution::Body>(function) ==
//   nullptr);
// }
...
//   Isa::Base::Definition declaration(Ttx::Lexical::Code::Type::Expose);

//   EXPECT_NOT(declaration.has_initializer());
//   EXPECT(implementation.define(
//       member, Isa::Base::Definition(
//                   Ttx::Lexical::Code::Type::Expose, attributes,
//                   initializer)));
//   const Isa::Base::Definition* facts = implementation.find(member);
//   ASSERT(facts != nullptr);
//   EXPECT(facts->get_modifier() == Ttx::Lexical::Code::Type::Expose);
