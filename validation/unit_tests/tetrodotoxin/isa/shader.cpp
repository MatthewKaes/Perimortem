...
//   const Ttx::Type* render_type =
//   root_type(render)->find_type("Render2D"_view); const Ttx::Type* contract =
//   type->find_type("Contract"_view); ASSERT(render_type != nullptr);
...
//   EXPECT_TEXT(
//       error.get_message(), "Shader state statements cannot lower
//       today."_view);
