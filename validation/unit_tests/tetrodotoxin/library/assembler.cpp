...
static Harness LibraryAssemblerTests = {
  .name = "Tetrodotoxin::Library::Assembler::x86_64"_view,
};

PERIMORTEM_UNIT_TEST(LibraryAssemblerTests, unary_encodings) {
...
PERIMORTEM_UNIT_TEST(LibraryAssemblerTests, register_moves) {
  Dynamic::Bytes machine_code;
  Assembler::x86_64 assembler(machine_code);
...
PERIMORTEM_UNIT_TEST(LibraryAssemblerTests, immediate_moves) {
  Dynamic::Bytes machine_code;
  Assembler::x86_64 assembler(machine_code);
...
PERIMORTEM_UNIT_TEST(LibraryAssemblerTests, memory_moves) {
  Dynamic::Bytes machine_code;
  Assembler::x86_64 assembler(machine_code);
...
PERIMORTEM_UNIT_TEST(LibraryAssemblerTests, call_relocation_slot) {
  Dynamic::Bytes machine_code;
  Assembler::x86_64 assembler(machine_code);
