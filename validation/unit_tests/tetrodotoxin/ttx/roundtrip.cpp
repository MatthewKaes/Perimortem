...
//   Ttx::Validation::TtxTests::Type::tetrodotoxin_test("Round trip
//   text!"_view);
...
//   EXPECT_EQ(Ttx::Validation::TtxTests::Type::arithmetic(Count(7)),
//   Count(24));
// }
...
//   EXPECT_EQ(Ttx::Validation::TtxTests::Type::type_call(Count(31)),
//   Count(31));
// }

// PERIMORTEM_UNIT_TEST(TtxAbi, ttx_addressable_call) {
//   EXPECT_EQ(
//       Ttx::Validation::TtxTests::Type::addressable_call(Count(37)),
//       Count(37));
// }
